...
//VERSION v1. MAMA GI 25/12/2018 
#define STRING_VERSION "Vico 2019"
...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "Vico 2019 "
...
//#define BANG_MAX 65 j-head new
#define PID_MAX 245// limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
//#define PID_MAX 60 j-head new
#ifdef PIDTEMP
...
// J-HEAD 0.4mm (Joseph Printer)

// J-HEAD new
//#define  DEFAULT_Kp 10.89
//#define  DEFAULT_Ki 0.68
//#define  DEFAULT_Kd 43.52
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 213.14
    #define  DEFAULT_bedKi 13.55
    #define  DEFAULT_bedKd 838.10
...
#define HOMING_FEEDRATE {2000, 2000, 500, 0}  // set the homing speeds (mm/min)
